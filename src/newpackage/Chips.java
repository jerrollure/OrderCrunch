...
public class Chips extends javax.swing.JFrame {
    ...
    private void btReceiptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btReceiptActionPerformed
        ...
        // Set the customer name label in the Chips frame
        lbName.setText(receipt);
        
        // If the customer name is not entered in the Main Window, show an error message and return
        if (Main.lbMain.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Peek a Customer name in Main Window");  
            return;
        } if (tbOrders.getRowCount() == 0 ) {
            // If there are no customer orders, show an error message and return
            JOptionPane.showMessageDialog(this, "Enter customer orders"); 
            return;
        } if (lbTotal.getText().isEmpty()) {
            // If the customer orders is not totaled, show an message and return
            JOptionPane.showMessageDialog(this, "Total customer orders"); 
            return; 
        } if (txAmount.getText().isEmpty()){
            // If the payment amount is not entered, show an message and return
            JOptionPane.showMessageDialog(this, "Enter Amount");
            return;
        } if (lbChange.getText().isEmpty()) {
            // If the customer change is not calculated, show an message 
    ...
    private void btClearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btClearActionPerformed
        ...
        spProduct1.setValue(1);
        spProduct2.setValue(1);
        spProduct3.setValue(1);
        spProduct4.setValue(1);
        spProduct5.setValue(1);
        spProduct6.setValue(1);
        spProduct7.setValue(1);
        spProduct8.setValue(1);
        spProduct9.setValue(1);
        spProduct10.setValue(1);
        spProduct11.setValue(1);
        spProduct12.setValue(1);
        spProduct13.setValue(1);
        spProduct14.setValue(1);
        spProduct15.setValue(1);
        spProduct16.setValue(1);
        spProduct17.setValue(1);
        spProduct18.setValue(1);
